...
export const fetchCourseCategories = async () => {
  ...
  try {
    ...
    console.log("Printing the response for this : ",response.data.allCategories);
...
export const addCourseDetails = async (data, token) => {
  ...
  console.log("Hello Hello Hello ji please");
...
export const updateStatus = async (data, token) => {
  ...
  const toastId = toast.loading("Loading...")
  try {
    const response = await apiConnector("POST", UPDATE_STATUS_API, data, {
      Authorization: `Bearer ${token}`,
    })
...
export const deleteSection = async (data, token) => {
  ...
  console.log("Printing the formData in dlete Section : ");
...
export const deleteCourse = async (data, token) => {
  const toastId = toast.loading("Loading...")
  console.log("Printing the data in course Deletion : ",data);

  const newdata = {
    courseId:data,
  }
  try {
    const response = await apiConnector("POST", DELETE_COURSE_API, newdata, {
      Authorization: `Bearer ${token}`,
    })
